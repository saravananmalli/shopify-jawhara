 ...
 * or focusing it opens a secondary cascading panel to the reading-end side — a flyout
    ...
    <li className={hasFlyout ? "group/row relative" : undefined}>
      <MenuLink
        ...
        className={`flex items-center justify-between rounded-lg px-3 py-2 text-sm transition-colors ${
          highlighted
            ? "border-s-2 border-gold-600 bg-gold-50 font-semibold text-brown-900"
      ...
      {hasFlyout && (
        <div className="invisible absolute start-full top-0 z-10 ps-3 opacity-0 transition-[opacity,visibility] duration-200 ease-luxury group-hover/row:visible group-hover/row:opacity-100 group-focus-within/row:visible group-focus-within/row:opacity-100">
