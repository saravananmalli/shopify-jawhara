    ...
    <section className="bg-[#FAF8F5]">
      <div className="grid page-container grid-cols-1 gap-10 py-6 sm:py-16 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          ...
          <h2 className="font-sans text-2xl leading-tight text-gold-600 sm:text-[28px]">
            {t.headingLine1}
            <br />
          ...
          <div className="mt-6 flex gap-2 sm:gap-3">
            <Button
              ...
              iconPosition="end"
              className="flex-1 px-3 py-3 text-center font-sans text-[11px] font-bold uppercase tracking-wider sm:flex-none sm:px-6 sm:text-xs"
            >
              {t.exploreSolitaires}
            </Button>
            <Button
