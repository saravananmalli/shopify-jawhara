      ...
      {categories.length === 0 ? (
        ...
        <>
          <div
            ...
            className="mt-2.5 flex snap-x snap-mandatory gap-4 overflow-x-auto pb-0 pe-(--page-gutter) sm:mt-6 sm:pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
