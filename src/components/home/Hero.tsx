...
export default function Hero({ banners }: { banners: HeroBanner[] }) {
  ...
  return (
    <section
      className={`relative w-full touch-pan-y overflow-hidden sm:aspect-auto sm:h-[42vw] sm:max-h-[calc(100svh-12rem)] sm:min-h-60 lg:max-h-[calc(100svh-440px)] lg:min-h-[420px] ${
